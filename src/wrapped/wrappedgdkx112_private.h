...
GO(gdk_gc_unref, vFp)
GO(gdk_gc_values_mask_get_type, LFv)
...
GO(gdk_image_type_get_type, LFv)
...
GO(gdk_offscreen_window_get_type, LFv)
GO(gdk_offscreen_window_set_embedder, vFpp)
GO(gdk_overlap_type_get_type, LFv)
...
GO(gdk_pango_renderer_get_type, LFv)
...
GO(gdk_rgb_dither_get_type, LFv)
...
GO(gdk_window_class_get_type, LFv)
...
GO(gdk_window_impl_get_type, LFv)
GO(gdk_window_impl_x11_get_type, LFv)
...
GO(gdk_window_object_get_type, LFv)
...
//GLOB(gdk_display, sizeof(void*))
DATA(gdk_threads_lock, sizeof(void*))
DATA(gdk_threads_unlock, sizeof(void*))
