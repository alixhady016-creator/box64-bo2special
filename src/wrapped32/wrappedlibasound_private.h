...
//GOM(snd_async_add_handler, iFEbp_ipp)
...
GO(snd_user_file, iFpbp_)
GO(snd_input_stdio_open, iFbp_pp)
GO(snd_input_stdio_attach, iFbp_Si)
GO(snd_input_buffer_open, iFbp_pl)
GO(snd_input_close, iFp)
//GOM(snd_input_scanf, iFEppV)
GO(snd_input_gets, pFppL)
GO(snd_input_getc, iFp)
GO(snd_input_ungetc, iFpi)
GO(snd_output_stdio_open, iFbp_pp)
GO(snd_output_stdio_attach, iFbp_Si)
GO(snd_output_buffer_open, iFbp_)
GO(snd_output_buffer_string, LFpbp_)
GO(snd_output_close, iFp)
//GOM(snd_output_printf, iFEppV)
//GOM(snd_output_vprintf, iFEppp)
GO(snd_output_puts, iFpp)
GO(snd_output_putc, iFpi)
GO(snd_output_flush, iFp)
GO(snd_strerror, pFi)
//GOM(snd_lib_error_set_handler, iFEp)
GO(snd_config_top, iFbp_)
GO(snd_config_load, iFpp)
GO(snd_config_load_override, iFpp)
GO(snd_config_save, iFpp)
GO(snd_config_update, iFv)
GO(snd_config_update_r, iFbp_bp_p)
GO(snd_config_update_free, iFp)
GO(snd_config_update_free_global, iFv)
GO(snd_config_search, iFppbp_)
//GOM(snd_config_searchv, iFEpbp_V)
GO(snd_config_search_definition, iFpppbp_)
GO(snd_config_expand, iFppppbp_)
GO(snd_config_evaluate, iFpppbp_)
GO(snd_config_add, iFpp)
GO(snd_config_delete, iFp)
GO(snd_config_delete_compound_members, iFp)
GO(snd_config_copy, iFbp_p)
GO(snd_config_make, iFbp_pu)
GO(snd_config_make_integer, iFbp_p)
GO(snd_config_make_integer64, iFbp_p)
GO(snd_config_make_real, iFbp_p)
GO(snd_config_make_string, iFbp_p)
GO(snd_config_make_pointer, iFbp_p)
GO(snd_config_make_compound, iFbp_pi)
GO(snd_config_imake_integer, iFbp_pl)
GO(snd_config_imake_integer64, iFbp_pI)
GO(snd_config_imake_real, iFbp_pd)
GO(snd_config_imake_string, iFbp_pp)
GO(snd_config_imake_pointer, iFbp_pp)
...
GO(snd_config_get_id, iFpbp_)
GO(snd_config_get_integer, iFpbl_)
GO(snd_config_get_integer64, iFpp)
GO(snd_config_get_real, iFpp)
GO(snd_config_get_ireal, iFpp)
GO(snd_config_get_string, iFpbp_)
GO(snd_config_get_ascii, iFpbp_)
GO(snd_config_get_pointer, iFpbp_)
...
GO(snd_pcm_access_mask_malloc, iFbp_)
...
GO(snd_pcm_area_copy, iFrpuu_Lrpuu_Lui)
GO(snd_pcm_area_silence, iFrpuu_Lui)
//GO(snd_pcm_areas_copy, iFbpuu_Lbpuu_LuLi) // it's arrays, 1 per channel, not simple pointers
//GO(snd_pcm_areas_silence, iFbpuu_LuLi)    // same
GO(snd_pcm_avail, lFp)
GO(snd_pcm_avail_delay, iFpbl_bl_)
...
GO(snd_pcm_format_mask_malloc, iFbp_)
...
GO(snd_pcm_get_params, iFpbL_bL_)
GO(snd_pcm_get_chmap, pFp)
//GOM(snd_pcm_hook_add, iFEbp_pupp)
...
GO(snd_pcm_hw_params_get_min_align, iFpBL_)
...
GO(snd_pcm_hw_params_malloc, iFBp_)
...
GO(snd_pcm_hw_params_set_buffer_size_first, iFppbL_)
GO(snd_pcm_hw_params_set_buffer_size_last, iFppbL_)
GO(snd_pcm_hw_params_set_buffer_size_max, iFppbL_)
GO(snd_pcm_hw_params_set_buffer_size_min, iFppbL_)
GO(snd_pcm_hw_params_set_buffer_size_minmax, iFppbL_bL_)
...
GO(snd_pcm_hw_params_set_period_size_first, iFppbL_p)
GO(snd_pcm_hw_params_set_period_size_integer, iFpp)
GO(snd_pcm_hw_params_set_period_size_last, iFppbL_p)
GO(snd_pcm_hw_params_set_period_size_max, iFppbL_p)
GO(snd_pcm_hw_params_set_period_size_min, iFppbL_p)
GO(snd_pcm_hw_params_set_period_size_minmax, iFppbL_pbL_p)
GO(snd_pcm_hw_params_set_period_size_near, iFppbL_p)
...
//GOS(snd_pcm_info_get_sync, pFpp)
GO(snd_pcm_info_malloc, iFBp_)
...
GO(snd_pcm_scope_malloc, iFBp_)
GO(snd_pcm_scope_s16_get_channel_buffer, pFpu)
GO(snd_pcm_scope_s16_open, iFppbp_)
...
//GOM(snd_pcm_scope_set_ops, vFEpbppppppp_)
...
GO(snd_pcm_status_malloc, iFbp_)
...
GO(snd_pcm_subformat_mask_malloc, iFbp_)
...
GO(snd_pcm_sw_params_get_avail_min, iFpbL_)
GO(snd_pcm_sw_params_get_boundary, iFpbL_)
GO(snd_pcm_sw_params_get_silence_size, iFpbL_)
GO(snd_pcm_sw_params_get_silence_threshold, iFpbL_)
GO(snd_pcm_sw_params_get_sleep_min, iFpp)
GO(snd_pcm_sw_params_get_start_mode, uFp)
GO(snd_pcm_sw_params_get_start_threshold, iFpbL_)
GO(snd_pcm_sw_params_get_stop_threshold, iFpbL_)
GO(snd_pcm_sw_params_get_tstamp_mode, iFpp)
GO(snd_pcm_sw_params_get_xfer_align, iFpbL_)
GO(snd_pcm_sw_params_get_xrun_mode, uFp)
GO(snd_pcm_sw_params_malloc, iFbp_)
...
GO(snd_pcm_writen, lFpbp_L)
GO(snd_pcm_xrun_mode_name, pFu)
GO(snd_spcm_init, iFpuuiiuuu)
GO(snd_spcm_init_duplex, iFppuuiiuuuu)
GO(snd_spcm_init_get_params, iFppbL_bL_)
GO(snd_rawmidi_open, iFbp_bp_pi)
GO(snd_rawmidi_open_lconf, iFbp_bp_pip)
...
GO(snd_rawmidi_info_malloc, iFbp_)
...
GO(snd_rawmidi_params_malloc, iFbp_)
...
GO(snd_rawmidi_status_malloc, iFbp_)
...
GO(snd_timer_query_open, iFbp_pi)
GO(snd_timer_query_open_lconf, iFbp_pip)
...
GO(snd_timer_open, iFbp_pi)
GO(snd_timer_open_lconf, iFbp_pip)
GO(snd_timer_close, iFp)
//GOM(snd_async_add_timer_handler, iFEbp_ppp)
...
GO(snd_timer_ginfo_malloc, iFbp_)
...
GO(snd_timer_info_malloc, iFbp_)
...
GO(snd_timer_params_malloc, iFbp_)
...
GO(snd_timer_status_malloc, iFbp_)
GO(snd_timer_status_free, vFp)
GO(snd_timer_status_copy, vFpp)
//GOS(snd_timer_status_get_timestamp, pFpp)
...
GO(snd_hwdep_dsp_status_malloc, iFbp_)
...
GO(snd_hwdep_dsp_image_malloc, iFbp_)
...
GO(snd_card_get_longname, iFibp_)
GO(snd_ctl_open, iFbp_pi)
GO(snd_ctl_open_lconf, iFbp_pip)
GO(snd_ctl_close, iFp)
GO(snd_ctl_nonblock, iFpi)
//GOM(snd_async_add_ctl_handler, iFEbp_ppp)
...
GO(snd_ctl_elem_id_malloc, iFbp_)
...
GO(snd_ctl_card_info_malloc, iFBp_)
...
GO(snd_ctl_elem_list_malloc, iFbp_)
...
GO(snd_ctl_elem_info_malloc, iFbp_)
...
GO(snd_ctl_elem_value_malloc, iFbp_)
...
GO(snd_hctl_open, iFbp_pi)
GO(snd_hctl_open_ctl, iFbp_p)
...
//GOM(snd_mixer_elem_new, iFEbp_uipp)
...
GO(snd_mixer_class_malloc, iFBp_)
...
//GO(snd_mixer_selem_register, iFpbiuppp_bp_)
...
GO(snd_mixer_selem_ask_playback_dB_vol, iFplibl_)
GO(snd_mixer_selem_ask_playback_vol_dB, iFplbl_)
...
GO(snd_mixer_selem_get_playback_volume, iFpibl_)
GO(snd_mixer_selem_get_capture_volume, iFpibl_)
GO(snd_mixer_selem_get_playback_dB, iFpibl_)
GO(snd_mixer_selem_get_capture_dB, iFpibl_)
...
GO(snd_mixer_selem_get_playback_volume_range, iFpbl_bl_)
GO(snd_mixer_selem_get_playback_dB_range, iFpbl_bl_)
GO(snd_mixer_selem_set_playback_volume_range, iFpll)
GO(snd_mixer_selem_get_capture_volume_range, iFpbl_bl_)
GO(snd_mixer_selem_get_capture_dB_range, iFpbl_bl_)
...
GO(snd_mixer_selem_id_malloc, iFbp_)
...
GO(snd_seq_open, iFbp_pii)
GO(snd_seq_open_lconf, iFbp_piip)
GO(snd_seq_name, pFp)
GO(snd_seq_type, uFp)
...
GO(snd_seq_system_info_malloc, iFbp_)
...
GO(snd_seq_client_info_malloc, iFbp_)
...
GO(snd_seq_client_pool_malloc, iFbp_)
...
GO(snd_seq_port_info_malloc, iFbp_)
...
GO(snd_seq_port_subscribe_malloc, iFbp_)
...
GO(snd_seq_query_subscribe_malloc, iFbp_)
...
GO(snd_seq_queue_info_malloc, iFbp_)
...
GO(snd_seq_queue_status_malloc, iFbp_)
...
GO(snd_seq_queue_tempo_malloc, iFbp_)
...
GO(snd_seq_queue_timer_malloc, iFbp_)
...
GO(snd_seq_event_input, iFpbp_) //TODO: does snd_seq_event needs wrapping?
...
GO(snd_seq_remove_events_malloc, iFbp_)
